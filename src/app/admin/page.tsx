    ...
    <AppLayout profile={profile || { full_name: 'Kassier', email: '', role: 'admin' }}>
      <div className="space-y-6 max-w-5xl mx-auto w-full">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-bold text-white tracking-tight">Kassier-Dashboard</h1>
          <p className="text-sm text-slate-400">Übersicht aller ausstehenden Spesenberichte und Webling-Export.</p>
        </div>
