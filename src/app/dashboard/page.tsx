    ...
    <AppLayout profile={profile || { full_name: 'Nutzer', email: '', role: 'user' }}>
      <div className="space-y-6 max-w-5xl mx-auto w-full">
        <div className="flex flex-col gap-1">
          <h1 className="text-[27px] font-bold text-[#E5EAF7] tracking-tight">Meine Spesenabrechnungen</h1>
          <p className="text-[13px] text-[#C0C0C0]">Übersicht über deine eingereichten Berichte und deren Status.</p>
        </div>
